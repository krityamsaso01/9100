...
fwrite($socket, "BEST DEAL STORES\n\n");//About
...
fwrite($socket, $ESC. '!' . "\x18");  //Emphasized + Double-height mode selected (ESC ! (16 + 8)) 24 dec => 18 hex
fwrite($socket, "# ITEMS SOLD 2\n");//About
fwrite($socket, $ESC. '!' . "\x00"); //Character font A selected (ESC ! 0)
fwrite($socket, "11/03/13  19:53:17\n\n");


fwrite($socket, $ESC. 'a' . chr(1)); //Character font A selected (ESC ! 0)
fwrite($socket, "CENTER");//About
